...
export interface ProjectItem {
  ...
  name: string;
  tagline: string;
  category: "BUSINESS" | "RESTAURANT" | "REAL ESTATE" | "HEALTHCARE" | "LIFESTYLE" | "E-COMMERCE" | "PHOTOGRAPHY" | string;
  shortDesc: string;
  longDesc: string;
  clientType: string;
  techTags: string[];
...
export interface WhyNetwebPoint {
  number: string;
  title: string;
  description: string;
}
...
export const businessSolutionsData: BusinessSolution[] = [
  {
    id: "restaurant",
    category: "Restaurant",
...
export const whyNetwebData: WhyNetwebPoint[] = [
  {
    number: "01",
