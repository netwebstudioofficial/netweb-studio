        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <RevealOnScroll>
            ...
            <p className="text-base sm:text-xl text-[#A7ADA5] max-w-3xl leading-relaxed">
              We reject off-the-shelf templates and slow bloated themes. Every client engagement receives tailored strategic planning, high-contrast bespoke UI design, intelligent AI automation, and modern web architecture.
            </p>
          </RevealOnScroll>
        </div>
      </section>
