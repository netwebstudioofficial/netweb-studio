      ...
      <section className="py-16 sm:py-24 border-b border-white/[0.08] bg-[#0c0e0c]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <RevealGroup className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {/* Starter Tier */}
            <RevealChild className="rounded-2xl bg-[#101310] border border-white/[0.08] overflow-hidden flex flex-col justify-between group hover:border-[#A3FF12]/40 transition-all">
              <div>
            ...
            <RevealChild className="rounded-2xl bg-[#141814] border-2 border-[#A3FF12]/40 relative overflow-hidden flex flex-col justify-between shadow-[0_0_30px_rgba(163,255,18,0.1)] group">
