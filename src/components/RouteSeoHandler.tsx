...
const routeMetaMap: Record<string, { title: string; description: string }> = {
  ...
  "/work": {
    title: "Selected Work & Portfolio — NETWEB STUDIO",
    description: "Explore verified case studies, technical architecture breakdowns, and client conversion metrics delivered by NETWEB STUDIO.",
  },
  "/process": {
