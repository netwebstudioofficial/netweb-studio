...
export const Button = ({
  ...
  const variantStyles = {
    ...
    black: "bg-black text-white border border-white/20 hover:border-white/50 hover:bg-[#121612] hover:text-white active:translate-y-0.5 shadow-[0_4px_16px_rgba(0,0,0,0.6)]",
