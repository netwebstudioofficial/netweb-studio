  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="relative rounded-2xl bg-[#101410]/85 backdrop-blur-xl border border-white/[0.14] shadow-[0_25px_60px_rgba(0,0,0,0.85),0_0_40px_rgba(163,255,18,0.12)] overflow-hidden"
      >
        {/* Browser Top Navigation Bar */}
        <div className="px-4 py-3 bg-[#0a0d0a]/90 backdrop-blur-md border-b border-white/[0.08] flex items-center justify-between">
