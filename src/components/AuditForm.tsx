...
import { submitAuditForm, AuditFormData, AuditDemoResult } from "../services/apiService";
import { Button } from "./Button";
import { AlertCircle, CheckCircle2, Sparkles, Activity, Smartphone, Search, Target, ArrowRight } from "lucide-react";
...
export const AuditForm: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!formData.businessName || !formData.name || !formData.email || !formData.websiteUrl) {
      setErrorMessage("Please fill in business name, your name, email, and current website URL.");
      return;
    }
    ...
    try {
      ...
      setErrorMessage(err.message || "Failed to submit audit request. Please try again.");
    } finally {
      setIsLoading(false);
    }
  };
  ...
  return (
    <div className="w-full bg-[#101310] border border-white/[0.08] rounded-2xl p-6 sm:p-10 shadow-2xl relative overflow-hidden" id="audit-form-container">
      ...
      {!demoResult ? (
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
          ...
          <div className="lg:col-span-5 space-y-6">
            ...
            <p className="text-sm sm:text-base text-[#A7ADA5] leading-relaxed font-normal">
              Get a quick look at where your current website can improve. Our engineering and design team reviews your site against 4 critical dimensions: speed, mobile responsiveness, search ranking, and conversion flow.
            </p>
            ...
            <div className="space-y-3 pt-2">
              <div className="flex items-start gap-3 text-xs text-[#F5F7F2]">
                ...
                <div>
                  <strong className="text-white block">Speed & Core Web Vitals</strong>
                  <span className="text-[#A7ADA5]">Pinpoint scripts and uncompressed assets dragging down load times.</span>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 text-xs text-[#F5F7F2]">
                ...
                <div>
                  <strong className="text-white block">Mobile User Journey</strong>
                  <span className="text-[#A7ADA5]">Audit tap targets, navigation clarity, and horizontal overflow issues.</span>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 text-xs text-[#F5F7F2]">
                ...
                <div>
                  <strong className="text-white block">Conversion Optimization</strong>
                  <span className="text-[#A7ADA5]">Identify where high-intent visitors hesitate and drop off.</span>
                </div>
              </div>
            </div>

            <div className="p-3.5 rounded bg-[#141814] border border-white/[0.08] text-xs text-[#A7ADA5]">
              🔒 100% confidential. No spam, no sales harassment. Just actionable technical insights.
            </div>
          </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  >
                    {businessTypes.map((type) => (
                      <option key={type} value={type} className="bg-[#101310] text-white">
                        {type}
                      </option>
                    ))}
                  </select>
                ...
                <div>
                  ...
                  >
                    {goals.map((goal) => (
                      <option key={goal} value={goal} className="bg-[#101310] text-white">
                        {goal}
                      </option>
                    ))}
                  </select>
        ...
        /* Results View matching prompt requirements */
        <div className="space-y-8" id="audit-results-view">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-[#A7ADA5]">
                  Target: <span className="text-white font-mono">{formData.websiteUrl}</span> • Request ID: <span className="text-[#A3FF12] font-mono">{submittedId}</span>
                </p>
              </div>
            </div>
          ...
          {/* Important Explicit Demo Notice as Mandated by Prompt */}
          <div className="p-4 rounded-lg bg-[#141814] border border-amber-500/30 text-amber-300 text-xs flex items-start gap-2.5">
            ...
            <div>
              ...
              <span>
                Note: In preview mode without live domain crawlers, the baseline scores below demonstrate example metric diagnostics. Our senior technologists will perform your actual live diagnostic report and email the complete breakdown to <strong className="text-white">{formData.email}</strong>.
              </span>
            </div>
          </div>

          {/* Metric Score Cards as Specified in Prompt */}
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
            <div className="p-5 rounded-xl bg-[#141814] border border-white/[0.08] relative overflow-hidden">
              <div className="flex items-center justify-between mb-2">
                <span className="text-xs font-mono uppercase text-[#A7ADA5]">Performance</span>
              ...
              <div className="w-full bg-white/10 h-1.5 rounded-full mt-3 overflow-hidden">
                <div className="bg-[#A3FF12] h-full" style={{ width: `${demoResult.performanceScore}%` }} />
              </div>
            </div>

            <div className="p-5 rounded-xl bg-[#141814] border border-white/[0.08] relative overflow-hidden">
              <div className="flex items-center justify-between mb-2">
                <span className="text-xs font-mono uppercase text-[#A7ADA5]">Mobile Experience</span>
              ...
              <div className="w-full bg-white/10 h-1.5 rounded-full mt-3 overflow-hidden">
                <div className="bg-[#A3FF12] h-full" style={{ width: `${demoResult.mobileScore}%` }} />
              </div>
            </div>

            <div className="p-5 rounded-xl bg-[#141814] border border-white/[0.08] relative overflow-hidden">
              <div className="flex items-center justify-between mb-2">
                <span className="text-xs font-mono uppercase text-[#A7ADA5]">SEO Quality</span>
              ...
              <div className="w-full bg-white/10 h-1.5 rounded-full mt-3 overflow-hidden">
                <div className="bg-[#A3FF12] h-full" style={{ width: `${demoResult.seoScore}%` }} />
              </div>
            </div>

            <div className="p-5 rounded-xl bg-[#141814] border border-white/[0.08] relative overflow-hidden">
              <div className="flex items-center justify-between mb-2">
                <span className="text-xs font-mono uppercase text-[#A7ADA5]">Conversion</span>
              ...
              <div className="w-full bg-white/10 h-1.5 rounded-full mt-3 overflow-hidden">
                <div className="bg-[#A3FF12] h-full" style={{ width: `${demoResult.conversionScore}%` }} />
              </div>
            </div>
          </div>
          ...
          <div className="pt-4 flex flex-col sm:flex-row items-center justify-between gap-4 border-t border-white/[0.08]">
            <p className="text-xs text-[#A7ADA5]">
              Ready to resolve these bottlenecks with a high-performance custom build?
            </p>
